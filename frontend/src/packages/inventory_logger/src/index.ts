...
export type DataKey = {tag: "ItemCounter", values: void} | {tag: "RentalCounter", values: void} | {tag: "Item", values: readonly [u64]} | {tag: "Rental", values: readonly [u64]} | {tag: "ItemRentals", values: readonly [u64]} | {tag: "UserRentals", values: readonly [string]};
...
export interface Client {
   ...
   */
  add_item: ({owner, name, description, rental_price_per_day}: {owner: string, name: string, description: string, rental_price_per_day: i128}, options?: {
    /**
   ...
   * Get item details
   */
  get_item: ({item_id}: {item_id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Get rental details
   */
  get_rental: ({rental_id}: {rental_id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  is_overdue: ({rental_id}: {rental_id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Issue/rent an item
   */
  issue_item: ({renter, item_id, rental_days, deposit_amount}: {renter: string, item_id: u64, rental_days: u64, deposit_amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * Return an item
   */
  return_item: ({rental_id, returner}: {rental_id: u64, returner: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_item_rentals: ({item_id}: {item_id: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_user_rentals: ({user}: {user: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  update_item_availability: ({item_id, is_available, caller}: {item_id: u64, is_available: boolean, caller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
